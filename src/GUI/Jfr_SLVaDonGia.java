 ...
 * @author ADMIN
 */
public class Jfr_SLVaDonGia extends javax.swing.JFrame {

    /**
     * Creates new form Jfr_SLVaDonGia
     */
    public static Jfr_SLVaDonGia sl;

    public Jfr_SLVaDonGia() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jfr_SLVaDonGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Jfr_SLVaDonGia().setVisible(true);
            }
        });
    }
